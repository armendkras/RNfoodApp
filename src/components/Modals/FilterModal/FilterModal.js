...
import { StyleSheet, Text, View,Animated,TouchableWithoutFeedback,Modal,Platform} from 'react-native'
import { ScrollView } from 'react-native-gesture-handler';
import { IconButton,TwoPointSlider,TextButton,TextIconButton } from '../..';
                ...
                {constants.delivery_time.map((item, index) => {
                    return (
                        <TextButton
                            ...
                            label={item.label}
                            labelStyle={{
                                colors: item.id == deliveryTime ? COLORS.white : COLORS.gray,
                                ...FONTS.body3
                            }}
